...
class Core_model  extends CI_Model{
	...
	public  function update($tabela=null, $data=null, $condicoes = null){
		...
		if ($tabela && $this->db->table_exists($tabela) && is_array($data) && is_array($condicoes)) {
			...
			if ($this->db->update($tabela, $data, $condicoes)) {
				...
				$this->session->set_flashdata('erro', 'Nao foi possivel actualizar os dados');
			}
		}else{
			return false;
		}
	...
	public function generate_unuque_code($tabela=null, $tipo_code=null, $tamanho_codigo=null, $campo_procura=null) {


		do{

			$codigo= random_string($tipo_code, $tamanho_codigo);
	...
	public function count_all_results($tabela=null, $data=null, $condicoes=null) {
